                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarEcommerce">
                                    <ul class="nav-second-level">
                                        ...
                                        <li>
                                            <a href="/profil_b">Profil Balai</a>
                                        </li>

                                        <li>
                                            <a href="/penyakit_b">Data Penyakit</a>
                                        </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarMaps">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="/report-pelayanan">Pelayanan</a>
                                        </li>
                                        <li>
                                            <a href="/report-hewan-sakit">Konsultasi Hewan Sakit</a>
                                        </li>
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                2015 - <script>document.write(new Date().getFullYear())</script> &copy; akupa.id by <a href="">Stenly S</a> 
                            </div>
        ...
        <script src="../assets/libs/summernote/summernote-bs4.min.js"></script>
         ...
         <script>
            ...
            $('#cari').click(function(){
                ...
                if (from =='' || to == '') {
                alert('Pastikan priode waktu terpilih!');
                }else{

    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <a data-toggle="modal" data-target="#add-dokter" href="javascript:void(0);" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i>New Penyakit</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="text-sm-right">
                            <button type="button" class="btn btn-success mb-2 mr-1"><i class="mdi mdi-cog"></i></button>
                            <button type="button" class="bt btn-light mb-2 mr-1">Import</button>
                            <button type="button" class="btn btn-linght mb-2">Export</button>
                        </div>
                    </div><!-- end col-->
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="/penyakit_b/{{ $item->id }}" method="post">
                                    @csrf
                                    @method('delete')
                            ...
                            <form method="POST" action="/penyakit_b/{{ $item->id }}">
                                @csrf
                                @method('put')
                                               ...
                                               <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ $item->nama_penyakit }}" name="nama_penyakit" required="required" class="form-control" placeholder="Enter Text">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="id_jenis_hewan" id="">
...
<form method="POST" action="/penyakit_b">
    @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">New Penyakit</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body p-4">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_penyakit" required="required" class="form-control" placeholder="Enter Text">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="id_jenis_hewan" id="" class="form-control">
                                @foreach ($jenis as $item)
                                <option value="{{ $item->id }}">{{ $item->nama_hewan }}</option>
                                @endforeach
                            </select>
